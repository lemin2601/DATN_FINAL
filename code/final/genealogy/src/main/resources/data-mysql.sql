...
INSERT INTO `genealogy`.`user` (`user_id`, `active`, `email`, `last_name`, `name`, `password`) VALUES ('2', '1', 'user@user.com.vn', 'Demo', 'User', '$2a$10$V8qzY/1VIaOnWHgqCFOCEusducgkeLPJoNVbABFD2RDZd5Q0w7BL6');
INSERT INTO `genealogy`.`user_role` (`role_id`, `user_id`) VALUES ('2', '2');
